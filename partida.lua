...
local function arbolTrade(event, contador, carta)
...
local function trigoTrade(event, contador, carta)
    local i = jugadorActual
    jugadores[i].cartas2 = jugadores[i].cartas2 - 1
...
local function rocaTrade(event, contador, carta)
    local i = jugadorActual
    jugadores[i].cartas5 = jugadores[i].cartas5 - 1
...
local function ladrilloTrade(event, contador, carta)
    local i = jugadorActual
    jugadores[i].cartas3 = jugadores[i].cartas3 - 1
...
local function vacaTrade(event, contador, carta)
    local i = jugadorActual
    jugadores[i].cartas4 = jugadores[i].cartas4 - 1
...
function seleccionParaDar(contador1, carta)
    ...
    arbolUser:addEventListener("tap", function(event) arbolTrade(event, contador1, carta) end)
    trigoUser:addEventListener("tap", function(event) trigoTrade(event, contador1, carta) end)
    ladrilloUser:addEventListener("tap", function(event) ladrilloTrade(event, contador1, carta) end)
    vacaUser:addEventListener("tap", function(event) vacaTrade(event, contador1, carta) end)
    rocaUser:addEventListener("tap", function(event) rocaTrade(event, contador1, carta) end)
end
